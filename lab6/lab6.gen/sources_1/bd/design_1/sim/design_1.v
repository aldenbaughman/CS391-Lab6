...
module design_1
  ...
  wire [31:0]picorv32_axi_0_b_type_counter;
  wire [31:0]picorv32_axi_0_i_type_counter;
  wire [31:0]picorv32_axi_0_instr_fetch_counter;
  wire [31:0]picorv32_axi_0_j_type_counter;
  wire [31:0]picorv32_axi_0_ldmem_counter;
  ...
  wire [31:0]picorv32_axi_0_r_type_counter;
  wire [31:0]picorv32_axi_0_s_type_counter;
  wire [31:0]picorv32_axi_0_stmem_counter;
  wire picorv32_axi_0_trap;
  wire [31:0]picorv32_axi_0_u_type_counter;
  ...
  design_1_picorv32_axi_0_0 picorv32_axi_0
       (.b_type_counter(picorv32_axi_0_b_type_counter),
        .clk(zynq_ultra_ps_e_0_pl_clk0),
        .i_type_counter(picorv32_axi_0_i_type_counter),
        .instr_fetch_counter(picorv32_axi_0_instr_fetch_counter),
        .irq(xlconstant_0_dout),
        .j_type_counter(picorv32_axi_0_j_type_counter),
        .ldmem_counter(picorv32_axi_0_ldmem_counter),
        ...
        .pcpi_ready(xlconstant_0_dout[0]),
        .pcpi_wait(xlconstant_0_dout[0]),
        .pcpi_wr(xlconstant_0_dout[0]),
        .r_type_counter(picorv32_axi_0_r_type_counter),
        .resetn(util_vector_logic_0_Res),
        .s_type_counter(picorv32_axi_0_s_type_counter),
        .stmem_counter(picorv32_axi_0_stmem_counter),
        .trap(picorv32_axi_0_trap),
        .u_type_counter(picorv32_axi_0_u_type_counter));
  ...
  design_1_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .S01_AXI_araddr(picorv32_axi_0_mem_axi_ARADDR),
        .S01_AXI_arprot(picorv32_axi_0_mem_axi_ARPROT),
        .S01_AXI_arready(picorv32_axi_0_mem_axi_ARREADY),
        .S01_AXI_arvalid(picorv32_axi_0_mem_axi_ARVALID),
        .S01_AXI_awaddr(picorv32_axi_0_mem_axi_AWADDR),
        .S01_AXI_awprot(picorv32_axi_0_mem_axi_AWPROT),
        .S01_AXI_awready(picorv32_axi_0_mem_axi_AWREADY),
        .S01_AXI_awvalid(picorv32_axi_0_mem_axi_AWVALID),
        .S01_AXI_bready(picorv32_axi_0_mem_axi_BREADY),
        .S01_AXI_bvalid(picorv32_axi_0_mem_axi_BVALID),
        .S01_AXI_rdata(picorv32_axi_0_mem_axi_RDATA),
        .S01_AXI_rready(picorv32_axi_0_mem_axi_RREADY),
        .S01_AXI_rvalid(picorv32_axi_0_mem_axi_RVALID),
        .S01_AXI_wdata(picorv32_axi_0_mem_axi_WDATA),
        .S01_AXI_wready(picorv32_axi_0_mem_axi_WREADY),
        .S01_AXI_wstrb(picorv32_axi_0_mem_axi_WSTRB),
        .S01_AXI_wvalid(picorv32_axi_0_mem_axi_WVALID),
  ...
  design_1_vio_0_0 vio_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        .probe_in0(picorv32_axi_0_trap),
        .probe_in1(picorv32_axi_0_r_type_counter),
        .probe_in2(picorv32_axi_0_i_type_counter),
        .probe_in3(picorv32_axi_0_s_type_counter),
        .probe_in4(picorv32_axi_0_b_type_counter),
        .probe_in5(picorv32_axi_0_u_type_counter),
        .probe_in6(picorv32_axi_0_j_type_counter),
        .probe_in7(picorv32_axi_0_instr_fetch_counter),
        .probe_in8(picorv32_axi_0_stmem_counter),
        .probe_in9(picorv32_axi_0_ldmem_counter),
