...
//               /home/ugrad/yc3146/lab6/lab6.gen/sources_1/bd/design_1/ip/design_1_picorv32_axi_0_0/design_1_picorv32_axi_0_0_stub.v
...
(* CHECK_LICENSE_TYPE = "design_1_picorv32_axi_0_0,picorv32_axi,{}" *) (* CORE_GENERATION_INFO = "design_1_picorv32_axi_0_0,picorv32_axi,{x_ipProduct=Vivado 2025.1,x_ipVendor=xilinx.com,x_ipLibrary=module_ref,x_ipName=picorv32_axi,x_ipVersion=1.0,x_ipCoreRevision=1,x_ipLanguage=VERILOG,x_ipSimLanguage=MIXED,ENABLE_COUNTERS=1,ENABLE_COUNTERS64=1,ENABLE_REGS_16_31=1,ENABLE_REGS_DUALPORT=1,TWO_STAGE_SHIFT=1,BARREL_SHIFTER=0,TWO_CYCLE_COMPARE=0,TWO_CYCLE_ALU=0,COMPRESSED_ISA=0,CATCH_MISALIGN=1,CATCH_ILLINSN=1,ENABLE_PCPI=0,ENABLE_MUL=0,ENABLE_FAST_MUL=0,ENABLE_DIV=0,ENABLE_IRQ=0,ENABLE_IRQ_QREGS=1,ENABLE_IRQ_TIMER=1,ENABLE_TRACE=0,REGS_INIT_ZERO=0,MASKED_IRQ=0x00000000,LATCHED_IRQ=0xFFFFFFFF,PROGADDR_RESET=0x80000000,PROGADDR_IRQ=0x00000010,STACKADDR=0x80070000}" *) (* DowngradeIPIdentifiedWarnings = "yes" *) 
(* IP_DEFINITION_SOURCE = "module_ref" *) (* X_CORE_INFO = "picorv32_axi,Vivado 2025.1" *) 
module design_1_picorv32_axi_0_0(clk, resetn, trap, mem_axi_awvalid, 
  ...
  pcpi_ready, irq, eoi, trace_valid, trace_data, r_type_counter, i_type_counter, s_type_counter, 
  b_type_counter, u_type_counter, j_type_counter, instr_fetch_counter, stmem_counter, 
  ldmem_counter)
...
/* synthesis syn_force_seq_prim="clk" */;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 clk CLK" *) (* X_INTERFACE_MODE = "slave" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF mem_axi, ASSOCIATED_RESET resetn, FREQ_HZ 99999001, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN design_1_zynq_ultra_ps_e_0_0_pl_clk0, INSERT_VIP 0" *) input clk /* synthesis syn_isclock = 1 */;
