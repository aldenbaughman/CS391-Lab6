...
//Date        : Mon Dec  1 15:11:57 2025
//Host        : cs730-test4.bu.edu running 64-bit unknown
//Command     : generate_target pleasework.bd
//Design      : pleasework
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "pleasework,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=pleasework,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=9,numReposBlks=9,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=1,numPkgbdBlks=0,bdsource=USER,da_zynq_ultra_ps_e_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "pleasework.hwdef" *) 
module pleasework
   ();
  ...
  pleasework_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  pleasework_blk_mem_gen_0_0 blk_mem_gen_0
  ...
  pleasework_picorv32_axi_0_0 picorv32_axi_0
  ...
  pleasework_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  pleasework_smartconnect_0_0 smartconnect_0
  ...
  pleasework_util_vector_logic_0_0 util_vector_logic_0
       (.Op1(proc_sys_reset_0_peripheral_aresetn),
        .Op2(vio_0_probe_out0),
        .Res(util_vector_logic_0_Res));
  pleasework_vio_0_0 vio_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        .probe_in0(picorv32_axi_0_trap),
        .probe_out0(vio_0_probe_out0));
  pleasework_xlconstant_0_0 xlconstant_0
       (.dout(xlconstant_0_dout));
  pleasework_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
